...
namespace omega {
BoxBody::BoxBody(const glm::rect& rect, BodyType type, b2FixtureDef& fixture_def, float gravity_scale, float angle, b2World* world) : body_(nullptr), dimensions_(rect.w, rect.h) {
	b2BodyDef body_def;
