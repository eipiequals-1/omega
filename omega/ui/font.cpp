...
util::sptr<gfx::texture::Texture> Font::render_text(const std::string &text, const glm::vec4 &color) {
    SDL_Color sdl_color;
    ...
    util::sptr<gfx::texture::Texture> tex = gfx::texture::Texture::create_from_surface(surf, GL_LINEAR, GL_LINEAR);
