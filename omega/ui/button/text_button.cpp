...
TextButton::TextButton(f32 x, f32 y, f32 w, f32 h, std::function<void()> on_click, const TextButtonBuilder &builder) : ImageButton(x, y, w, h, on_click), text_texture(nullptr), text_width(builder.width), text_height(builder.height) {
